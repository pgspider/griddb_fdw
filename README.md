...
- **clustername** as *boolean*

  GridDB cluster name.
  
- **notification_member** as *string*
...
- **use_remote_estimate** as *boolean*

- **batch_size** as *integer*

- **fdw_startup_cost** as *interger*

- **fdw_tuple_cost** as *integer*
...
Create an appropriate user mapping:
    ...
    CREATE USER MAPPING FOR CURRENT_USER SERVER griddb_svr 
