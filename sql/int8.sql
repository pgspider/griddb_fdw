...
DELETE FROM INT8_TBL;
--Testcase 194:
INSERT INTO INT8_TBL(q1) VALUES((-1::int8<<63)+1);
--Testcase 195:
SELECT q1 FROM INT8_TBL;
ROLLBACK;
...
DELETE FROM INT8_TBL;
--Testcase 197:
INSERT INTO INT8_TBL(q1) VALUES ((-9223372036854775808)::int8 * (-1)::int8);
--Testcase 198:
SELECT q1 FROM INT8_TBL;
ROLLBACK;
...
DELETE FROM INT8_TBL;
--Testcase 206:
INSERT INTO INT8_TBL(q1) VALUES ((-9223372036854775808)::int8 * (-1)::int4);
--Testcase 207:
SELECT q1 FROM INT8_TBL;
ROLLBACK;
...
DELETE FROM INT8_TBL;
--Testcase 215:
INSERT INTO INT8_TBL(q1) VALUES ((-9223372036854775808)::int8 * (-1)::int2);
--Testcase 216:
SELECT q1 FROM INT8_TBL;
ROLLBACK;
