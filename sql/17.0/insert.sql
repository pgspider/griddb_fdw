...
-- griddb cannot support insert_test_type type
...
-- create foreign table inserttesta (f1 int, f2 insert_pos_ints) server griddb_svr OPTIONS (table_name 'inserttesta');
...
-- drop table inserttest2;
-- drop foreign table inserttesta;
...
-- create foreign table inserttesta (f1 insert_nnarray);
